...
Only physical backup could use `PITR` technique. If you need to use `PITR`, please enable `WAL` and `archive log`. For this part, please refer to my [post]({%post_url 2015/2015-07-18-postgresql-recover %});  
