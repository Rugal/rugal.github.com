...
8. use `API key` to call google speech API use [curl]({% post_url 2013/2013-11-22-linux-curl-command-usage %}) if you are using linux, this will save you a lot of time to see a quick result:  
{%highlight bash%}
