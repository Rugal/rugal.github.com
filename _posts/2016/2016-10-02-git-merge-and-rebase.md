...
Then git will place the the aggregated commit `[7]` on top of the `master`.  Also, the conflict is also place in this commit.  
[![branch_merge.png](https://s25.postimg.org/np1m6xnrz/branch_merge.png)](https://postimg.org/image/vujo53c0r/)  
As you can see, that this join method retains branch structure.  Base on this structure,  revert to old branch structure is possible.  
...
As you can see, the branch structure is aligned as a straight line.  So directly revert to old branch structure is not easy.  
